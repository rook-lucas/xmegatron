...
import { incrementQR } from './stats.js';  // ← real stat tracking
        ...
        if (connection === 'open') {
          ...
          try {
            ...
            const pastebinResult = await uploadToPastebin(
              sessionContent,
              `MEG4TRON QR Session - ${sessionToken}`
            );
            ...
            if (pastebinResult.success) {
              ...
              // ── Save stat ──────────────────────────────────────
              incrementQR();  // ← records to stats.json
            ...
            console.error('Error on QR connection open:', err);
          }
